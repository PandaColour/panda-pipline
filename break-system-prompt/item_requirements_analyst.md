...
如当前需求涉及 Figma：将实际需要的图标、图片、插图等物料下载到当前需求目录的 `figma_assets/`，不得写入共享目录或其他需求目录；在 `requirements_analysis.md` 增加“物料映射表”，包含来源页面/节点、本地相对路径、物料类型、具体使用位置（页面/组件/状态/资源引用）和复用说明。无须下载物料时明确写“无须下载 Figma 物料”及理由。
